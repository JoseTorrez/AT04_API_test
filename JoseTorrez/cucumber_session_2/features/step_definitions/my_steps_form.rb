...
When(/^User write your first name as ([a-zA-Z]*) and last name as ([a-zA-Z]*)$/) do |firs_tName, last_Name|
  puts "Your first name is: #{firs_tName} and your last name is: #{last_Name}"
end

When(/^User write your username as ([a-z.]*)$/) do |user_name|
  puts "Your username is: #{user_name}"
end
